...
This registry holds the user's **real** repos. The anonymized, worked project trees that ship with the skill live in `references/5-examples/` — those are generic teaching examples, this is machine-local evidence.
...
- Generic anonymized worked trees — `references/5-examples/00_index.md`
- The layout picker — `references/02_decision-tree.md`
