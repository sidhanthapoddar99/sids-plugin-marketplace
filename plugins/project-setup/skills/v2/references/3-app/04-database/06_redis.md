...
State bind-mounts under `data/` — placement doctrine owned by `references/3-app/04-database/00_provisioning.md`.
...
- Adding Redis for a single-worker app's cache when a dict would do — the in-memory-vs-Redis choice is owned by `references/3-app/04-database/00_provisioning.md`

## See also

- `references/3-app/04-database/00_provisioning.md` — in-process memory vs Redis (the choice), coupled to worker count
- `references/3-app/10-deployment/00_serving.md` — why worker count drives the cache decision
- `references/3-app/04-database/05_postgres.md`
