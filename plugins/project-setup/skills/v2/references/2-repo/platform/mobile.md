...
- `references/2-repo/env-and-config/frontend-env-isolation.md` — build-time vs runtime (mobile is heavily build-time)
- `references/2-repo/tooling/ci-cd-future.md` — adapt for mobile-specific runners
