...
- `references/2-repo/layouts/02_multi-app-monorepo.md` — shared packages story
- `references/3-app/frontend/tokens-setup.md` — `tokens.css` lives in `packages/styles` when shared
