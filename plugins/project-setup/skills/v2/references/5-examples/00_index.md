...
| `04_ml-training-project.md` | 04 ML | uvenv global env + `requirements.txt` · `configs/` · `tasks/*.dstack.yml` · `scripts/cloud/` · `checkpoints/` | `references/2-repo/layouts/04_ml-project.md`, `references/3-app/backend/ml-python-flow.md`, `references/2-repo/ml-orchestration/` |
