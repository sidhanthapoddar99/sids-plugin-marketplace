...
- brief: `AGENTS.md` exists at the repo root and `CLAUDE.md` does not. Migrate unique instructions before removing an existing file (`11_conventions.md` § The agent brief).
