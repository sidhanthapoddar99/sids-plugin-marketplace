...
App CI/CD (`references/ci-cd-future.md`) is about lint + test + build images. **ML CI/CD** has additional concerns: smoke-training, eval against benchmark, model registry / promotion, dataset versioning, and reproducibility.
