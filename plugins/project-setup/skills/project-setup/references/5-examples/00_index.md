...
- **Anonymized.** Tool and service names are generic (`tablefmt`, `api-platform`, `flow-editor`). Substitute freely; the shape is the lesson.
...
| `06_embeddable-package.md` | 06 embeddable | `packages/flow-editor` product + **framework-less core** + a reference host app · single-artifact publishing · embedding seams | `references/2-repo/01-layouts/06_embeddable-package.md`, `references/3-app/05-package/02_embeddable-seams.md` |
