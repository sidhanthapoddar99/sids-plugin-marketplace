...
This decision is coupled to `references/production/app-server-and-workers.md`:
...
- `references/databases/sqlite-conventions.md` — WAL, busy_timeout, the single-writer model
- `references/databases/postgres-conventions.md`
- `references/databases/redis-conventions.md`
- `references/production/app-server-and-workers.md` — why worker count drives the cache decision
