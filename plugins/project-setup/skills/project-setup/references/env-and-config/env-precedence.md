...
Backends typically have one per-service `.env`; frontends have their own (`VITE_*` / `NEXT_PUBLIC_*`) — see `references/env-and-config/frontend-env-isolation.md`.
...
- Those vars get interpolated into `config.yaml` via `${VAR}` — see `references/env-and-config/yaml-var-interpolation.md`.
- **Config files** override separately: `config.local.yaml` overrides `config.yaml` — see `references/env-and-config/config-local-overrides.md`.
...
- `references/env-and-config/root-env-shared-only.md`
- `references/env-and-config/per-service-config-yaml.md`
- `references/env-and-config/frontend-env-isolation.md`
- `references/env-and-config/secrets-matrix.md`
- `references/env-and-config/build-time-vs-runtime.md`
- `references/env-and-config/yaml-var-interpolation.md`
- `references/env-and-config/config-local-overrides.md`
