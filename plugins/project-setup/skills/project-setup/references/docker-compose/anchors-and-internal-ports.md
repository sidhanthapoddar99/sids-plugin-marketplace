...
In **dev** (apps on host) the app binds a host port directly; in **prod** (containers) it's the internal port + compose network. The internal port being a constant is what keeps the two modes consistent — see `references/docker-compose/compose-as-deployment-modes.md`.
...
- `references/docker-compose/compose-as-deployment-modes.md`
- `references/docker-compose/overrides-vs-profiles.md`
- `references/docker-compose/docker-folder-layout.md`
