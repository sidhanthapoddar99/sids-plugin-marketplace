...
- `env-and-config/env-precedence.md` — why compose `environment:` (tier 3) carries URLs and `.env` carries secrets
- `references/architecture/frontend/vite-proxy-nginx-pair.md` — the in-stack nginx baseline this page's resolver pattern extends
