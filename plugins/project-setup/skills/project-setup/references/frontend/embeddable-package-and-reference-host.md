...
Read `references/topologies/09_embeddable-package-and-reference-host.md` for the topology and tree; this is the how-to for the seams and the build.
...
- `references/topologies/09_embeddable-package-and-reference-host.md` — the topology + tree + `ctl` shape.
...
- `references/frontend/multi-frontend-workspaces.md` — the pnpm/turbo workspace mechanics reused for the package + reference-host split.
- `references/env-and-config/frontend-env-isolation.md` — for the reference host's own env, the usual `VITE_*` rules still apply.
