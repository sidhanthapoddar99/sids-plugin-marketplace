...
| `skills/project-setup/references/01_layout.md` to `11_conventions.md` | Thirteen pages. Each owns one question: layout, env, routing, stack, frontend, backend, security, `ctl`, production, review passes, static checks, dynamic tests, conventions and audit order |
